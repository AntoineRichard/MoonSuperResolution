...
def parse_args() -> DSRConfig:
    ...
    config = DSRConfig(map_name=args.map_name,
...
class DEMSuperResolution:
    ...
    def rebuildTile(self, generated_dems: dict, generated_minmax: dict, K: float) -> List[np.ndarray]:
        ...
        Args:
            ...
            K (float): A value close to the mean of the generated images. Used to prevent floating point
                       cancellation when computing the standard deviation.
        Returns:
